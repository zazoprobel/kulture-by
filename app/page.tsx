    ...
    <>
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .h-inner{max-width:1320px;margin:0 auto;padding:0 32px;height:84px;display:flex;align-items:center;gap:36px}
        ...
        .sec{max-width:1320px;margin:52px auto 0;padding:0 32px}.sec-h{display:flex;align-items:baseline;justify-content:space-between;margin-bottom:20px}.sec-t{font-family:var(--font-h);font-size:clamp(32px,3.2vw,40px);font-weight:700;line-height:1.15}
        ...
        @media (max-width: 767px) {
          ...
          .gsearch,.cat-row,.sec,.hero{padding-left:16px;padding-right:16px}
          .gs-inner{flex-direction:column;align-items:stretch}
          .gs-sel,.gs-btn{width:100%}
